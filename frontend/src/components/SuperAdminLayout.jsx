...
const menus = [
  ...
  { label: 'Manajemen Admin', path: '/superadmin/admin', icon: '👤' },
  { label: 'Pengaduan', path: '/superadmin/pengaduan', icon: '📋' },
  { label: 'Fasilitas', path: '/superadmin/fasilitas', icon: '🏢' },
  { label: 'Teknisi', path: '/superadmin/teknisi', icon: '🔧' },
  { label: 'Mahasiswa', path: '/superadmin/mahasiswa', icon: '🎓' },
  { label: 'Laporan', path: '/superadmin/laporan', icon: '📄' },
]
